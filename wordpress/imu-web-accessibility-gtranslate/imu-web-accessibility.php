<?php
/**
 * Plugin Name: İMÜ Web Erişilebilirlik – GTranslate
 * Plugin URI:  https://www.medeniyet.edu.tr/
 * Description: GTranslate dil değişimini algılayan erişilebilirlik tercih araçları ve klavye ile erişilebilen bir yan panel ekler.
 * Version:     1.0.18
...
function imu_wa_add_script_attributes( $tag, $handle ) {
	...
	$attributes = sprintf(
		' data-language="%s" data-position="%s" data-wa-gtranslate="true"',
		esc_attr( $language ),
...
function imu_wa_render_settings_page() {
	...
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'İMÜ Web Erişilebilirlik – GTranslate', 'imu-web-accessibility' ); ?></h1>
		<p><?php esc_html_e( 'Erişilebilirlik düğmesinin konumunu ve paket yükleme yöntemini belirleyin.', 'imu-web-accessibility' ); ?></p>
		<p><?php esc_html_e( 'Araç dili ve sesli okuma dili GTranslate seçimine göre sayfa yenilenmeden güncellenir.', 'imu-web-accessibility' ); ?></p>
